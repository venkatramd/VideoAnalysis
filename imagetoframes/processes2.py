...
p1 = Process(target=save_i_keyframes1,args=(cwd+allvideos[2],))
p2 = Process(target=save_i_keyframes2,args=(cwd+allvideos[3],))
...
p1 = Process(target=save_i_keyframes1,args=(cwd+allvideos[6],))
p2 = Process(target=save_i_keyframes2,args=(cwd+allvideos[7],))
